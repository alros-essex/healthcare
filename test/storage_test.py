...
class TestStorage(unittest.TestCase):
    ...
    def test_insert_select_doctor(self):
        ...
        self.assertEqual(1, len(doctors))
    ...
    def test_insert_select_patient(self):
        ...
        self.assertEqual('John', patient.name)
        self.assertEqual('Nowhere st. 0', patient.address)
        self.assertEqual('+0 1111 0000', patient.phone)
    ...
    def test_select_insert_appointment(self):
        ...
        self.assertEqual('Who', appointment.staff.name)
        self.assertEqual('John', appointment.patient.name)
        self.assertEqual(AppointmentType.NORMAL, appointment.type)
        self.assertEqual(date, appointment.date)
    ...
    def test_select_appointment_dates(self):
        ...
        self.assertEqual(['01-01-2022', '02-02-2022'], storage.select_appointment_dates())
